  ...
  return (
    <div className="terms-box">
      ...
      <p>
        ...
        information that is collected and recorded by Axiom and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Axiom. This policy is not applicable to any
      ...
      <p>
        Axiom follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Axiom uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Axiom.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Axiom, which are sent directly
      ...
      <p>
        Note that Axiom has no access to or control over these cookies that are
      ...
      <p>
        Axiom's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Axiom does not knowingly collect any Personal Identifiable Information
