  ...
  return (
    <div className="terms-box">
      ...
      <p>
        ...
        of Axiom's Website, located at axiom.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Axiom if you do not agree to take all
        of the terms and conditions stated on this page. Our Terms and
      ...
      <p>
        We employ the use of cookies. By accessing Axiom, you agreed to use
        cookies in agreement with the Axiom's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Axiom and/or its licensors own the intellectual
        property rights for all material on Axiom. All intellectual property
        rights are reserved. You may access this from Axiom for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Axiom</li>
        <li>Sell, rent or sub-license material from Axiom</li>
        <li>Reproduce, duplicate or copy material from Axiom</li>
        <li>Redistribute content from Axiom</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Axiom
        ...
        of Axiom,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Axiom shall not be liable for the Comments
      ...
      <p>
        Axiom reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Axiom a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Axiom; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Axiom. Please include your name, your organization name,
      ...
      <p>
        No use of Axiom's logo or other artwork will be allowed for linking
